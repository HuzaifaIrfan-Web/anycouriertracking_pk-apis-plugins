...
Delivery Status for: <?php echo $tnum;?>
         ...
         <div class="col-3"><button class="btn btn-primary">Orgin SRC : <?php echo $status['Orgin_SRC'];?></button> <button class="btn btn-primary">Destination: <?php echo  $status['Destination'];?></button>
